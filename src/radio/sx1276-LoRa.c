...
{
    return (uint8_t)PAL_GpioPinOutGet(SX1276_PORT_DIO0, SX1276_PIN_DIO0);
    //GPIO_ReadInputDataBit( DIO0_IOPORT, DIO0_PIN );
}
...
uint32_t SX1276LoRaProcess( void )
{
    ...
    case RFLR_STATE_TX_INIT:
        ...
        //printf("rfbuffer=%s, RegPayloadLength=%d\r\n", RFBuffer, SX1276LR->RegPayloadLength);
    ...
    case RFLR_STATE_TX_RUNNING:	
    	...
    	if((( SX1276LR->RegIrqFlags & RFLR_IRQFLAGS_TXDONE ) == RFLR_IRQFLAGS_TXDONE) || (DIO0 == 1))
        {
            // Clear Irq
    		printf("RegIrqFlags = %02x\r\n", SX1276LR->RegIrqFlags);
